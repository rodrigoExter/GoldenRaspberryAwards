...
/**
 * Interface que define os metodos padrões de um controlador de CRUD
 * 
 * @author ruan
 *
...
public interface AbstractController<PK extends Serializable, T extends AbstractEntityClass<PK>, DTO extends AbstractDTO<PK, T>> {
  ...
  /**
   * Retorna Filtra as informações com base nas informações advindas do filter
   * 
  ...
  /**
   * Retorna uma instancia com o ID passado por parâmetro e remove o mesmo
   * 
   * @param id Id que queremos trabalhar
   * @return T com os valores encontrados
   */
